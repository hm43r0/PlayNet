...
@if($video)
<a href="{{ route('video.show', $video->id) }}" class="block group">
@endif
    <div class="bg-[#181818] rounded-xl overflow-hidden shadow-lg flex flex-col h-full w-[320px] min-w-[320px] max-w-[320px]">
        ...
        <div class="p-4 flex-1 flex flex-col justify-between">
            ...
            <div class="text-[#aaa] text-sm truncate">{{ $channel }} • {{ $meta }}</div>
        </div>
    </div>
@if($video)
</a>
